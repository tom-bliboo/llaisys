...
void argmax(tensor_t max_idx, tensor_t max_val, tensor_t vals) {
    ...
    CHECK_ARGUMENT(max_idx->ndim() == 1 && max_idx->numel() == 1, "Argmax index output must have shape [1]");
    CHECK_ARGUMENT(max_val->ndim() == 1 && max_val->numel() == 1, "Argmax value output must have shape [1]");
